...
class TestPortlet(TestCase):
    ...
    def test_invoke_add_view(self):
        ...
        self.failUnless(isinstance(mapping.values()[0], shibbolethloginportlet.Assignment))
    ...
    def test_obtain_renderer(self):
        ...
        self.failUnless(isinstance(renderer, shibbolethloginportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def test_render(self):
        # TODO: Pass any keywoard arguments to the Assignment constructor
        r = self.renderer(context=self.portal, assignment=shibbolethloginportlet.Assignment())
